...
///
/// Cost is not deducible from a type, so it is stated rather than derived.  The
/// default is the conservative one: a projecting comparator that says nothing
/// gets std::lower_bound.  That default is a judgement, not a measurement - an
