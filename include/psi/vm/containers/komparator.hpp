...
///
/// Contents:
///   - is_simple_comparator<T>   -- (comparator_traits.hpp) trait: can == replace double-negation test?
///   - is_direct_comparator<T>   -- (comparator_traits.hpp) trait: does a comparison read only the keys?
