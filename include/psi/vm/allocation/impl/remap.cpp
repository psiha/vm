...
#   if defined( __linux__ )
        ...
        BOOST_VERIFY( ::mprotect( address, current_size, allocation_type::commit ) == 0 );

        auto const actual_address{ ::mremap( address, current_size, required_size_for_end_expansion, realloc_type ) }; // https://laptrinhx.com/linux-mremap-tlb-flush-too-late-1728576753
