...
static_assert( file_open_flags<win32>::system_hints::sequential_access ==   FILE_FLAG_SEQUENTIAL_SCAN                             , "" );
static_assert( file_open_flags<win32>::system_hints::avoid_caching     == ( FILE_FLAG_NO_BUFFERING   | FILE_FLAG_WRITE_THROUGH   ), "" );
static_assert( file_open_flags<win32>::system_hints::temporary         == ( FILE_ATTRIBUTE_TEMPORARY | FILE_FLAG_DELETE_ON_CLOSE ), "" );

static_assert( file_open_flags<win32>::on_construction_rights::read    == FILE_ATTRIBUTE_READONLY, "" );
static_assert( file_open_flags<win32>::on_construction_rights::write   == FILE_ATTRIBUTE_NORMAL  , "" );
static_assert( file_open_flags<win32>::on_construction_rights::execute == FILE_ATTRIBUTE_READONLY, "" );
