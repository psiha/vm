...
////////////////////////////////////////////////////////////////////////////////
//------------------------------------------------------------------------------
#ifndef __ANDROID__ // TODO rather exclude in CMake
#include <psi/vm/detail/posix.hpp>
#include <psi/vm/flags/opening.posix.hpp>
#include <psi/vm/mappable_objects/shared_memory/posix/mem.hpp>
#include <psi/vm/mappable_objects/file/file.posix.hpp>
...
namespace detail
{
        ...
        semid_{ -1 }
    {
        ...
        /// support mixing those in IPC), and the prescribed default ain't so
...
#       endif
        ...
        /// first semop() call) aka the "SysV semaphore fatal flaw": for
